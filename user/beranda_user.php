...
if (!isset($_SESSION['username'])) {
    ...
    echo "<script>alert('Oops! Anda tidak dapat mengakses halaman ini');window.location='../admin/beranda_admin.php';</script>";
}
...
<body class="bg-gray-100 min-h-screen">
    ...
    <header class="bg-blue-900 text-white text-center py-6 shadow">
        <h1 class="text-3xl font-bold">Beranda User</h1>
    </header>
    ...
    <div class="flex max-w-7xl mx-auto mt-8 px-4">
        ...
        <aside class="w-1/4 bg-white rounded shadow p-4">
            ...
            <ul class="space-y-2 text-gray-700">
                <li><a href="beranda_user.php" class="block font-semibold hover:text-blue-600">
                    Beranda
                    </a>
                </li>
                <li><a href="data_artikel.php" class="block hover:text-blue-600">
                    Kelola Artikel
                    </a>
                </li>
                <li><a href="data_gallery.php" class="block hover:text-blue-600">
                    Kelola Gallery
                    </a>
                </li>
                <li><a href="about.php" class="block hover:text-blue-600">
                    About
                    </a>
                </li>
                <li>
        ...
        <main class="w-3/4 bg-white rounded shadow p-6 ml-6">
            ...
            <p class="text-sm text-gray-500">
                Silakan gunakan menu di samping untuk melihat data.
            </p>
