...
<body class="bg-gray-100 text-gray-800 font-sans">
    ...
    <main class="max-w-3xl mx-auto p-6 bg-white rounded shadow mt-8">
        <h2 class="text-xl font-bold mb-4 text-lime-700">Tentang Saya</h2>
        <div class="space-y-6">
            <?php
                ...
                while ($data = mysqli_fetch_array($query)) {
                    echo "<div>";
                    echo "<p class='text-gray-700 text-justify'>" . htmlspecialchars($data['about'])
                        . "</p>";
                    echo "</div>";
                }
            ?>
