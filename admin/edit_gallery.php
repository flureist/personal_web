    ...
    <div class="flex max-w-7xl mx-auto mt-8 px-4">
        ...
        <aside class="w-1/4 bg-white rounded shadow p-4">
            ...
            <ul class="space-y-2 text-gray-700">
                ...
                <li><a href="data_gallery.php" class="block font-semibold text-red-800">Kelola Gallery</a></li>
...
mb-1">Judul Gambar</label>
                    <input type="text" id="judul" name="judul" required
                        value="<?php echo htmlspecialchars($data['judul']); ?>" class="w-full p-2 border rounded focus:outline-none focus:ring
...
mb-1">Ganti Gambar (Opsional)</label>
                    <input type="file" id="foto" name="foto" accept="image/*" class="block w-full text-sm text-gray-600 file:mr-4 file:py-2
...
file:bg-red-100 file:text-red-700 hover:file:bg-red-200">
                ...
                <div class="flex justify-end space-x-4">
                    <button type="submit"
                        class="bg-red-700 text-white px-4 py-2 rounded hover:bg-red-800 transition">Simpan
                        Perubahan</button>
